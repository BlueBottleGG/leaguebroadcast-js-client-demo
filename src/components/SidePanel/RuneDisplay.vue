            ...
            <div class="skin-panel" :class="{ 'mirror': mirror }">
                <transition :name="mirror ? 'slide-mirror' : 'slide'">
                    <div v-if="currentPlayer" :key="currentPlayerIndex" class="skin-panel-content">
                        ...
                        <img v-if="currentPlayer.champion"
                            :src="client.getCacheUrl(currentPlayer.champion.splashCenteredImg)" class="skin-splash"
                        ...
                        <div class="rune-perks-overlay">
                            <div class="rune-keystone">
                                <img v-if="currentPlayer.perks[0]"
                                    :src="client.getCacheUrl(currentPlayer.perks[0].iconPath)"
                                    class="rune-keystone-img" />
                            </div>

                            <div class="rune-row">
                                <img v-if="currentPlayer.perks[1]"
                                    :src="client.getCacheUrl(currentPlayer.perks[1].iconPath)" class="rune-perk-img" />
                                <img v-if="currentPlayer.perks[2]"
                                    :src="client.getCacheUrl(currentPlayer.perks[2].iconPath)" class="rune-perk-img" />
                                <img v-if="currentPlayer.perks[3]"
                                    :src="client.getCacheUrl(currentPlayer.perks[3].iconPath)" class="rune-perk-img" />
                            </div>

                            <div class="rune-row rune-row-small">
                                <img v-if="currentPlayer.perks[4]"
                                    :src="client.getCacheUrl(currentPlayer.perks[4].iconPath)" class="rune-perk-img" />
                                <img v-if="currentPlayer.perks[5]"
                                    :src="client.getCacheUrl(currentPlayer.perks[5].iconPath)" class="rune-perk-img" />
                            </div>

                            <div class="rune-row rune-row-shards">
                                <img v-if="currentPlayer.perks[6]"
                                    :src="client.getCacheUrl(currentPlayer.perks[6].iconPath)" class="rune-shard-img" />
                                <img v-if="currentPlayer.perks[7]"
                                    :src="client.getCacheUrl(currentPlayer.perks[7].iconPath)" class="rune-shard-img" />
                                <img v-if="currentPlayer.perks[8]"
                                    :src="client.getCacheUrl(currentPlayer.perks[8].iconPath)" class="rune-shard-img" />
                            </div>
                        </div>
                    </div>
                </transition>
