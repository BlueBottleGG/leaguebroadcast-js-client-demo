...
watch(
  ...
  (newSmite) => {
    ...
    smiteRevealTimer = setTimeout(
      () => {
        showSecured.value = true
      },
      START_DELAY + DURATION + 150,
    )
    ...
    <Transition name="smite-pop" appear>
      <div
        ...
        style="
          ...
          box-shadow: 0 0 14px color-mix(in oklab, var(--broadcast-accent) 30%, transparent);
      ...
      >
        <div class="flex flex-row items-center gap-3 px-4 py-3 min-w-64">
          ...
          <div
            class="smite-ring relative shrink-0 flex items-center justify-center"
          ...
          <div class="flex flex-col gap-0.5">
            <span
              class="smite-title leading-none"
              style="
                font-weight: 800;
                font-size: 12px;
                text-align: left;
            ...
            <span
              class="smite-time tabular-nums leading-none pt-1"
              :style="{
                fontWeight: '800',
                fontSize: '24px',
                textAlign: 'left',
            ...
            <div class="smite-badges flex items-center gap-2 mt-0.5">
              ...
              <span
                ...
                :style="{
                  ...
                  background: smite.wasKillingBlow
                    ? 'rgba(76,175,80,0.12)'
                    : 'rgba(232,64,87,0.12)',
